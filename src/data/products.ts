...
export const products: Product[] = [
    ...
    {
        slug: 'meghvin-foundation',
        name: 'MeghVin Foundation',
        kicker: 'Nonprofit website and admin · Web',
        tagline: 'The website and admin for a tree plantation and community trust, so the trustees run everything from one place.',
        summary:
            'MeghVin Foundation is a public charitable trust in Ahmedabad and Navi Mumbai. It plants and cares for trees at Sindoor Valley in Kharghar, runs a community kitchen and takes doctor-led health talks into schools and housing societies. The public site tells that story in English and Gujarati. Behind it, one admin gives the trustees control of everything: every word and photo on the site, the daily activity diary, gallery, stories, posters, letters and receipts, media, messages, settings and team. No code, and it works from a phone.',
        highlights: [
            'One admin for the whole organization: Overview, Page content, Activity diary, Stories, Gallery, Poster studio, Letters and receipts, Media library, Messages, Settings and Team.',
            'Every text and photo slot on every page is editable, with a live preview and a reset to the original. Only the pages that changed are regenerated.',
            'Daily activity diary in English and Gujarati with photos and tags. It goes live on save, and the public diary is searchable by month and tag.',
            'Poster studio on a Konva canvas with 8 brand templates for plantation days, health talks, events and thank-yous. A plant picker fills in Gujarati benefits and steps.',
            'Letters and receipts on the trust letterhead: auto-numbered donation receipts with the amount in words, certificates for a list of names from Excel, activity reports built from the diary, and A4 PDF export.',
            'Public site: programmes, a scroll-driven impact story over a survey map of Sindoor Valley, gallery, stories, volunteering and a donate flow with UPI and bank transfer.',
            'Photos upload straight to Cloudinary. Owner and editor roles use signed sessions. Form messages land in one inbox, and the site still renders from bundled content if the database is down.',
        ],
        platform: 'Web',
        status: 'Live',
        category: 'BusinessApplication',
        site: { url: 'https://meghvin.vercel.app', label: 'meghvin.vercel.app' },
        previewImage: { url: '/meghvin/og.jpg', width: 1200, height: 630 },
        tech: [
            { name: 'Next.js 16', icon: 'devicon-nextjs-plain' },
            { name: 'React 19', icon: 'devicon-react-original colored' },
            { name: 'TypeScript', icon: 'devicon-typescript-plain colored' },
            { name: 'Tailwind CSS 4', icon: 'devicon-tailwindcss-original colored' },
            { name: 'shadcn/ui', icon: '' },
            { name: 'Radix UI', icon: '' },
            { name: 'MongoDB Atlas', icon: 'devicon-mongodb-plain colored' },
            { name: 'Mongoose', icon: 'devicon-mongoose-original colored' },
            ...
            { name: 'Three.js', icon: 'devicon-threejs-original' },
            { name: 'React Three Fiber', icon: 'devicon-threejs-original' },
            { name: 'Konva', icon: '' },
            { name: 'Motion', icon: '' },
            { name: 'jsPDF', icon: '' },
            { name: 'Zod', icon: '' },
            { name: 'jose (JWT)', icon: '' },
            { name: 'bcrypt', icon: '' },
            { name: 'Marked', icon: 'devicon-markdown-original' },
            { name: 'Formspree', icon: '' },
            { name: 'Vercel', icon: 'devicon-vercel-original' },
        ],
        icon: '/meghvin/icon.png',
        image: '/meghvin/og.jpg',
        video: {
            src: '/meghvin/launch.mp4',
            poster: '/meghvin/launch-poster.jpg',
            title: 'MeghVin Foundation launch video: the trust\'s field work, its website, and one admin to run it all',
        },
        screens: [
            { src: '/meghvin/home-hero.jpg', title: 'Home', caption: 'The trust\'s story in English and Gujarati, with a shuffling deck of real field photos.' },
            { src: '/meghvin/admin-overview.jpg', title: 'Admin overview', caption: 'One place for the trustees: "What would you like to update today?"' },
            { src: '/meghvin/admin-diary.jpg', title: 'Activity diary', caption: 'Write today\'s work in English and Gujarati, tag it and add photos. It goes live on save.' },
            { src: '/meghvin/admin-page-content.jpg', title: 'Page content', caption: 'Every word and photo on every page, with a live preview.' },
            { src: '/meghvin/admin-gallery.jpg', title: 'Gallery', caption: 'Field photos in albums, with captions, uploaded straight from a phone.' },
            { src: '/meghvin/poster-studio.jpg', title: 'Poster studio', caption: 'Plantation-day posters for WhatsApp. The layout, fonts and colours stay on-brand.' },
            { src: '/meghvin/diary.jpg', title: 'Public diary', caption: 'Every day of work on the website, searchable by month and tag.' },
        ],
    },
];
